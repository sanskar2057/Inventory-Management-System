...
<body>
    <div class="container">
        ...
        <div class="loginBody">
            <h2>Sign Up</h2>
            <form name="register_form" action="register_process.php" method="POST" onsubmit="return Validate()">
            <p>Already have an account? <a href="login.php">Sign in</a></p>
                <div class="loginInputContainer">
                    <label>Full Name</label>
                    <input placeholder="full_name" type="text" name="full_name"/>
                </div>
                <div class="loginInputContainer">
                ...
                <div class="loginInputContainer">
                    ...
                    <a href="registerAdmin.php"><input type="button" value="Register as Admin" id="adminRegister"></a>
            </form>
        </div>
    </div>
